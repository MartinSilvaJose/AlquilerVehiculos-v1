...
public class Consola {
	...
	public static Alquiler leerAlquiler() {
		...
		if(TipoVehiculo.get(leerVehiculoMatricula()).equals(TipoVehiculo.TURISMO)) {
			vehiculo=new Turismo((Turismo)leerVehiculoMatricula());
		}
		if(TipoVehiculo.get(leerVehiculoMatricula()).equals(TipoVehiculo.AUTOBUS)) {
			vehiculo=new Autobus((Autobus)leerVehiculoMatricula());
		}
		if(TipoVehiculo.get(leerVehiculoMatricula()).equals(TipoVehiculo.FURGONETA)) {
			vehiculo=new Furgoneta((Furgoneta)leerVehiculoMatricula());
		}
